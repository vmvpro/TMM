...
Public Class cls_Cam_0000
    ...
    Public Sub Diagram1_Construction()
        ...
        table1 = diagramTableExcel("AngleDistance_0000")
        ...
        Dim p_AngleDistance(10) As Double
        ...
        Dim pd1_4(table1.Rows.Count - 1) As PointDouble
        Dim pd2_4(table1.Rows.Count - 1) As PointDouble
        ...
        For i As Integer = 0 To AngleDistance Step step1
            ...
            pd1_4(k) = doc2D.myCalculateCordinatePoint(mp_O0, r0_mm + Si1_len(k + 1), angle_CAM)
        ...
        doc2D.myDrawLineSeg(pd1_4(10), pd2_4(0))
