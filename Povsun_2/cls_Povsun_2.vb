...
Public Class cls_Povsun_2
    ...
    Sub Initialization(drZD_Student_ As DataRow)
        ...
        Dim dt_z2 As DataTable = Nothing
        Dim da_z2 As SQLiteDataAdapter = Nothing
        ...
        'da_z2.SelectCommand.Transaction = tran
        ...
        'Dim row As DataRow = DataBase.Row(v, TableName.z2_data)
