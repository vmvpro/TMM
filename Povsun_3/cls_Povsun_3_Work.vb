...
Partial Public Class cls_Povsun_3
    ...
    Sub test(counter As Long, v As Integer)
        ...
        'Dim dr_Mehanizm = StoredProcedure.RowZD(Table.Z3_Mehanizm, counter, v)
        'MechanismDraw(dr_Mehanizm, 1)

        'Dim dr_Speed = StoredProcedure.RowZD(Table.Z3_Speed, counter, v)
        'Mechanism_SpeedDraw(dr_Speed)

        'Dim dr_Acceleration = StoredProcedure.RowZD(Table.Z3_Acceleration, counter, v)
    ...
    Public Sub MechanismConstruction(tran As SQLiteTransaction, numberPosition As Integer)
        ...
        mp_C0 = doc2D.myCalculateCordinatePoint(mp_A, L_AB + L_BC, line_CordinateLineC, 0, enLocation.quarter_0_90)
    ...
    Public Sub Mechanism_Acceleration(tran As SQLiteTransaction, numberPosition As Integer)
        ...
        ap_c = doc2D.myCalculateCordinatePoint(ap_n3, angleCB + 90, ap_pi, 0)
