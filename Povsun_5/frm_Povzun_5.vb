...
Public Class frm_Povzun_5
    ...
    Dim dt_z5 As DataTable
    Dim da_z5 As SQLiteDataAdapter
    ...
    Dim povzun_5 As cls_Povsun_5
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Try

            'Dim Doc2D As New myDoc2D(ActiveDoc2D)

            povzun_5 = New cls_Povsun_5(drZD_Student)
    ...
    'Private Sub CreateDiagramEntity()
    '    Dim startInfo As ProcessStartInfo
    '    Dim pathDbMetal As String = "c:\Tools\DbMetal.exe"
    '    Dim argument1 As String = " /provider:Sqlite /conn ""Data Source = " & "d:\Doc\Work\MS Visual Studio\LINQDataSet\DataBase\SQLiteDataSet.db" & """ /dbml:SQLiteDataSet.dbml"
    '    Dim argument2 As String = " /code:SQLiteDataSet.cs SQLiteDataSet.dbml"
    '    startInfo = New ProcessStartInfo()
    '    startInfo.FileName = pathDbMetal
    '    startInfo.Arguments = String.Format("{0}", argument1)
    '    Process.Start(startInfo)
    '    startInfo.Arguments = String.Format("{0}", argument2)
    '    Process.Start(startInfo)
    'End Sub

    Private Sub frm_Povzun_5_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        txt_st_name.Text = "ПРО VMVPRO"
        cbo_id_zd.SelectedIndex = 5
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        DataBase.LoadDataAdapterAndDataTable(TableName.z5, da_z5, dt_z5)
        ...
        Dim dr_z5 As DataRow = dt_z5.NewRow
        dr_z5("id") = counter
        dr_z5("variant") = Convert.ToInt64(cbo_variant.Text)
        dt_z5.Rows.Add(dr_z5)
        da_z5.Update(dt_z5)
        ...
        Dim L_CD As Decimal = 0.25 * L_BC
        If (drData("L_CD").ToString() = "") Then drData("L_CD") = L_CD


        Dim L_BD As Decimal = L_BC + L_CD
        ...
        txt_m2.Text = m2.ToString() 'drData("m2")
        txt_m3.Text = m3.ToString() 'drData("m3")
        txt_m4.Text = m4.ToString() 'drData("m4")
    ...
    Private Sub ComboBox1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBox1.SelectedIndexChanged
        ...
        Try
            ...
            txt_L_bd.Text = drDataZd("L_bc") + drDataZd("L_cd")
    ...
    Private Sub ListBox1_MouseDoubleClick(sender As Object, e As MouseEventArgs) Handles ListBox1.MouseDoubleClick
        ...
        povzun_5.DrawOne(numberPosition)
    End Sub
